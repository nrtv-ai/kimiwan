...
export interface Message {
  ...
  type: MessageType;
  from: AgentId;
  to?: AgentId; // undefined for broadcasts
...
export interface CapabilityQuery {
  capabilities: Capability[];
  matchAll?: boolean; // If true, agent must have all capabilities
}
 ...
 * Event handler type
 */
export type EventHandler<T = unknown> = (event: BusEvent & { payload: T }) => void | Promise<void>;
