...
async function main() {
    ...
    const coop = new index_1.A2ACoop();
    ...
    coop.updateContext(projectContext.id, {
        research: {
    ...
    coop.sendMessage(writerAgent.id, researchAgent.id, 'Can you provide more details on Trend 2?');
    // Researcher responds
    coop.sendMessage(researchAgent.id, writerAgent.id, 'Trend 2 refers to shared context systems like A2A-Coop that enable stateful collaboration.', { relevantFinding: 'context-sharing' });
